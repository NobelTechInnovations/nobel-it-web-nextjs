    ...
    <div className="p-6 max-w-md mx-auto bg-white rounded-xl shadow-md">
      ...
      <form ref={form} onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <button 
            type="submit" 
            className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#6161FF] hover:bg-[#5151D5] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            Send Test Email
          </button>
        </div>
